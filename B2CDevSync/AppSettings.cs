...
namespace B2CDevSync
{
    public partial class AppSettings : Form
    {
        ...
        {
            var res = true;
            res = res & (txtSyncProfileName.Text != "");

            if (chkSyncAzureStorage.Checked)
            {
                res = res & (txtStorageConnectionString.Text != "");
                res = res & (txtStorageContainer.Text != "");
                res = res & (txtUIFolderPath.Text != "");
            }
            if (chkSyncB2CPolicies.Checked)
            {
                res = res & (txtPolicyFolderPath.Text != "");
            }
            return res;
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _settings.Configured = (_settings.SyncProfiles.Profiles.Count > 0);
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                var res = MessageBox.Show("Your configuration is incomplete. Please make sure you have at least one profile, and that you've setup the application settings.\n\r\n\rAre you sure you want to exit configuration?", "Settings Incomplete", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
